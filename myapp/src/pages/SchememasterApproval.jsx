...
// // ---------------------------modal 4---------------------------------
  ...
  <button  className="adminBtn1offcanvas"> Scheme Master Approval</button>
  ...
  <button className="adminBtn1offcanvas" onClick={handleBranchcreation}>Branch Creation Approval</button>
  <button className="adminBtn1offcanvas" onClick={handleDuepromotion} >Due Promotion Approval</button>
  <button className="adminBtn1offcanvas" onClick={handleSchememasterapproval} style={{background:"green",border:"2px solid black",boxShadow:"5px 3px 4px 2px"}}>Scheme Master Approval</button>
