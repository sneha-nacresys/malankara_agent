...
{/* 
  ...
  <button  className="adminBtn1offcanvas"> Rights  Approval</button>
  ...
  <button className="adminBtn1offcanvas" onClick={handleRights} style={{background:"green",border:"2px solid black",boxShadow:"5px 3px 4px 2px"}}>Rights Approval</button>
